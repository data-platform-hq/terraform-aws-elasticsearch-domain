...
variable "advanced_security_options_master_user_name" {
  description = "Main user's username, which is stored in the Amazon Elasticsearch Service domain's internal database. Applicable if advanced_security_options_internal_user_database_enabled set to true"
  type        = string
  default     = ""
}

variable "advanced_security_options_master_user_password" {
  description = "Main user's password, which is stored in the Amazon Elasticsearch Service domain's internal database. Applicable if advanced_security_options_internal_user_database_enabled set to true"
  type        = string
  default     = ""
}
...
variable "domain_policy" {
  description = "Policy for Elasticsearch domain"
  type        = string
  default     = ""
}
