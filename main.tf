...
resource "aws_elasticsearch_domain" "this" {
  ...
  dynamic "advanced_security_options" {
    ...
    content {
      ...
      master_user_options {
        master_user_arn      = var.advanced_security_options_internal_user_database_enabled ? null : (var.advanced_security_options_master_user_arn != "" ? var.advanced_security_options_master_user_arn : data.aws_caller_identity.current.arn)
...
resource "aws_elasticsearch_domain_policy" "this" {
  count       = var.create && var.domain_policy != "" ? 1 : 0
  domain_name = aws_elasticsearch_domain.this[0].domain_name

  access_policies = var.domain_policy
}
